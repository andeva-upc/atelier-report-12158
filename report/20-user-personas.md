...
<div style="page-break-inside: avoid; text-align: center; margin-top: 20px;">

<img src="assets/user-persona-carlos-mendoza.png" alt="User Persona de Carlos Mendoza" style="max-height: 20cm; max-width: 100%; width: auto; display: block; margin: 0 auto;">
...
<div style="page-break-inside: avoid; text-align: center; margin-top: 30px;">

<img src="assets/user-persona-valeria-torres.png" alt="User Persona de Valeria Torres" style="max-height: 20cm; max-width: 100%; width: auto; display: block; margin: 0 auto;">
...
<table border="1" style="border-collapse: collapse; width: 100%; border-color: black;">
	<tbody>
		<tr>
			...
			<td colspan="2"><center><b>Carlos Mendoza</b></center></td>
			<td colspan="2"><center><b>Valeria Torres</b></center></td>
        </tr>
        <tr>
			<td>Importancia</td>
			<td>Frecuencia</td>
