...
![](assets/mona-sans-font.png "Tipografía Mona Sans")
...
![](assets/arimo-font.png "Tipografía Arimo")
...
![](assets/pallete.jpg "Paleta de colores de atelier")
...
&emsp;&emsp;&emsp;&emsp;Para el desarrollo de la interfaz de usuario de "atelier", se ha seleccionado Vue.js como el marco de trabajo principal debido a su robustez y capacidad para gestionar aplicaciones web de gran escala. Esta decisión arquitectónica se fundamenta en el sistema de reactividad profunda y el DOM virtual que ofrece Vue, los cuales son ideales para construir una interfaz de usuario (UI) rápida, modular y altamente dinámica. Al emplear características modernas como la Composition API, el equipo de desarrollo podrá encapsular, organizar y reutilizar la lógica de negocio de manera limpia.
...
![](assets/vuetify.png "Vuetify")

&emsp;&emsp;&emsp;&emsp;A través del motor de temas de Vuetify, se inyectará el sistema de diseño exacto de la startup: el color institucional #0071eb dominará los botones de acción, estados de carga y elementos interactivos, mientras que la jerarquía tipográfica se configurará globalmente para renderizar Mona Sans en los titulares y Arimo en los cuerpos de texto o bloques de datos densos.